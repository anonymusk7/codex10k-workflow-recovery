...
Updated: 2026-05-10T10:30:38Z

This is a review queue for the 20 Gmail draft-batch packets. Sent: 7. Still draft-only: 13. Do not count any value here as revenue until completed and settled payment evidence exists in `data/ledger.csv`.
...
| 8 | C10K-087 American Battle Monuments Commission | draft | `r8757273967754748544` | USD 12,500 | Federal HRIS; slower, formal, no employee PII. |
